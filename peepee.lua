...
G2L["b"]["Size"] = UDim2.new(0, 200, 0, 64);
G2L["b"]["BorderColor3"] = Color3.fromRGB(0, 0, 0);
G2L["b"]["Text"] = [[Activate Trade Scam]];
G2L["b"]["Position"] = UDim2.new(0.19697, 0, 0.34225, 0);
	...
	Button.MouseButton1Click:Connect(function()
		...
		local function movePlayerUp()
			if player.Character and player.Character:FindFirstChild("HumanoidRootPart") then
				...
				humanoidRootPart.Position = humanoidRootPart.Position + Vector3.new(0, 0.1, 0)
			end
		end
	end)
